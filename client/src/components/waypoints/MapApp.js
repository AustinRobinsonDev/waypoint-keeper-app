...
const MapApp = () => {
  ...
  const { waypoints, getWaypoints, loading } = waypointContext;
  ...
  const [viewport, setViewport] = useState({
    ...
    <div>
        ...
        >
          {waypoints !== null ? (waypoints.map(singlePoint => (<Marker key={singlePoint._id} latitude={singlePoint.position[0]} longitude={singlePoint.position[1]} >
